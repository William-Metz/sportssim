...
const PITCHER_IP_PROJECTIONS = {
  ...
  'Max Fried':          { ipPerStart: 5.85, tier: 1, hand: 'L', team: 'NYY', pitchCount: 98, note: 'NYY OD starter (signed from ATL). Elite ground-ball LHP. 185 IP season. New team may cap deep in opener.' },
