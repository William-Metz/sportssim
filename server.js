...
let odWarRoom = null;
try { odWarRoom = require('./services/od-war-room-sync'); } catch (e) { console.error('[server] OD War Room not loaded:', e.message); }
