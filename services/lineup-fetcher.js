...
// Source: Baseball Savant framing metrics
const CATCHER_FRAMING = {
  'Patrick Bailey': { framingRuns: 18, team: 'SF' },
  'Adley Rutschman': { framingRuns: 15, team: 'BAL' },
  'Austin Wells': { framingRuns: 12, team: 'NYY' },
  'J.T. Realmuto': { framingRuns: 10, team: 'PHI' },
  'Jose Trevino': { framingRuns: 11, team: 'NYY' },
  'Cal Raleigh': { framingRuns: 14, team: 'SEA' },
  'Will Smith': { framingRuns: 5, team: 'LAD' },
  'Willson Contreras': { framingRuns: -5, team: 'STL' },
  'William Contreras': { framingRuns: -3, team: 'MIL' },
  'Salvador Perez': { framingRuns: -8, team: 'KC' },
  'Mitch Garver': { framingRuns: -10, team: 'SEA' },
  'Sean Murphy': { framingRuns: 6, team: 'ATL' },
  'Danny Jansen': { framingRuns: 8, team: 'BOS' },
  'Jonah Heim': { framingRuns: 7, team: 'TEX' },
  'Logan O\'Hoppe': { framingRuns: 9, team: 'LAA' },
  'Alejandro Kirk': { framingRuns: 4, team: 'TOR' },
  'Connor Wong': { framingRuns: 3, team: 'BOS' },
  'Bo Naylor': { framingRuns: 6, team: 'CLE' },
  'Tyler Stephenson': { framingRuns: 2, team: 'CIN' },
  'Yainer Diaz': { framingRuns: -6, team: 'HOU' },
  'Reese McGuire': { framingRuns: 1, team: 'BOS' },
  'Ivan Herrera': { framingRuns: 5, team: 'STL' },
  'Ryan Jeffers': { framingRuns: 7, team: 'MIN' },
  'Gabriel Moreno': { framingRuns: 4, team: 'ARI' },
  'Francisco Alvarez': { framingRuns: -4, team: 'NYM' },
  'MJ Melendez': { framingRuns: -7, team: 'KC' },
};
