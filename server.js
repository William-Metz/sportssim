      ...
      for (const g of schedule.slice(0, 20)) {
        ...
        const gameReady = {
          ...
          checks: {
            pitchersInDB: false,
            dkLines: false,
            weatherAvailable: isDome || !!homePark.lat, // dome = always OK, outdoor = need coords
            dome: isDome,
          },
          status: 'GO',
        };
